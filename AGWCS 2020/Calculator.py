...
if operator=="+":
    ...
    answer=float(number)**(1/float(number2))
    number=str(number)
    number2=str(number2)
    answer=str(answer)
    ...
    answer=math.log(float(number),float(number2))
    number=str(number)
    number2=str(number2)
    answer=str(answer)
    ...
    answer=(float(number)/180)
    number=str(number)
    answer=str(answer)
    print(number+" degrees is "+answer+" pi radians.")
elif operator=="deg":
    answer=(float(number)/math.pi)*180
    number=(float(number)/math.pi)
    number=str(number)
    answer=str(answer)
